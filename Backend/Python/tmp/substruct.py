...
remove["Sulfonate ester alkyl"]='[#6][O;R0][S;R0](=O)(=O)[#6]'
   
functions["Sulfonate ester aryl"]='c[S;R0](=O)(=O)Oc'
remove["Sulfonate ester aryl"]='c[S;R0](=O)(=O)Oc'
...
remove["Thioamide alkyl 1"]='H'
   
functions["Thioamide alkyl 2"]='c[C;R0]([NH2])=S'
remove["Thioamide alkyl 2"]='H'
  
functions["Thioisocyanate alkyl"]='CN=C=S'
remove["Thioisocyanate alkyl"]='CN=C=S'
   
functions["Thioisocyanate aryl"]='cN=C=S'
remove["Thioisocyanate aryl"]='cN=C=S'
...
remove["Alkyne alkyl"]='CC#C'
   
functions["Alkyne aryl"]='cC#C'
remove["Alkyne aryl"]='cC#C'

functions["Alkene alkyl"]='C[C;R0]=[C;R0]'
remove["Alkene alkyl"]='C[C;R0]=[C;R0]'
   
functions["Alkene aryl"]='c[C;R0]=[C;R0]'
remove["Alkene aryl"]='c[C;R0]=[C;R0]'
